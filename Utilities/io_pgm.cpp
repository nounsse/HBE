...
/*---------------------------------------------------------------------------*/
/** Read a PGM 8/16 Bits image file into an array of doubles.
 */
double *read_pgm_double(const char * fname, int * ncol, int *nrow)
{
  FILE * f;
  int c,bin;
  int depth,i,j;
...
/*---------------------------------------------------------------------------*/
/** Write an array of doubles into a PGM file.
 */
void write_pgm_double(const char *fname, const double *data, int ncol, int nrow)
{
  FILE * f;
  int i,j;
  int v,max,min;
...
/*---------------------------------------------------------------------------*/
/** Write an array of doubles into a 8bit PGM file.
 *    Normalize the maximum value of
 *  the doubles array to be 255.
 */
void write_pgm_normalize_double(const char *fname, const double *data,
                               int ncol, int nrow)
{
  FILE * f;
  int i,j;
...
/*---------------------------------------------------------------------------*/
/** Write an array of doubles into a 3channel-8bit PPM image file. Normalize
 *   the maximum value of the doubles array to be 255.
 */
void write_ppm_normalize_double(const char *fname, const double *rdata,
                               const double *gdata, const double *bdata,
                               int ncol, int nrow)
{
  FILE * f;
  int i,j;
